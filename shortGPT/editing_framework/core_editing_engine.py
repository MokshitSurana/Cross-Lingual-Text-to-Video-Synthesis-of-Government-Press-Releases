...
class CoreEditingEngine:
    ...
    def generate_video(self, schema:Dict[str, Any], output_file, logger=None) -> None:
        ...
        # visual_clips = visual_clips.reverse()
        # temp = visual_clips[0]
        # visual_clips[0] = visual_clips[-1]
        # visual_clips[-1] = temp
    ...
    def process_text_asset(self, asset: Dict[str, Any]) -> TextClip:
        ...
        text_clip_params['font'] = os.environ['FONT']
        #print(text_clip_params['text'], text_clip_params['font'])
        text_clip_params['txt'] = text_clip_params['text'].encode('utf-8')
